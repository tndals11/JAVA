...
class OuterClass {
    ...
    static String staticField = "외부 클래스의 정적필드";
    ...
    void outerMethod() {
        ...
        // 로컬 클래스 인스턴스화
        // : 메서드 내부에서만 쓰이기 때문에 인스턴스화도 내부에서 일어난다
...
public class A_Inner {
    public static void main(String[] args) {
        ...
        // 1) 외부 클래스 인스턴스화 필요 X
        //      >> 외부 클래스타입.내부클래스타입 변수명 = new 외부클래스명.내부클래스()
        OuterClass.StaticClass staticeClass = new OuterClass.StaticClass();

        staticeClass.display();
