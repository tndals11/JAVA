...
- 필드(속성)가 많거나, 필드에 필수값과 선택앖이 섞여 있을 때 유용
...
public class E_Builder {
    public static void main(String[] args) {
        // Pizza noBuilderPizza = new Pizza("파일애플 피자", "L", false, false, false);

        Pizza builderPizza = new Pizza.Builder("고구마피자", "M").build();
        Pizza optionalPizza = new Pizza.Builder("포테이토 피자", "S") // Builder 인스턴스 생성
