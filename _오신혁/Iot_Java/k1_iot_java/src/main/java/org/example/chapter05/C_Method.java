...
class   MyMath {
    ...
    void noReturn() {
        ...
        // return
        // : 자바 컴파일러가 변환타입의 void를 읽는경우
        //        해당 메서드늬 마지막에 return;을 자동 추가
    }
...
public class C_Method {
    public static void main(String[] args) {
        // 클래스타입 객체명 = new 클래스 생성자호출();
        // : 클래스 생성자는 반드시 한 개 이상 존재한다
        ...
        System.out.println(myMath.divide(10, 20)); // 자기 자신보다 큰 수로 나누면 값은 '0' 반환

        // System.out.println(myMath.divide(10, 0));
        // ArithmeticException / ny zero
        ...
        // cf) 인자는 실질적인 데이터
        //    - 매개변수는 해당 데이터를 메서드 블록 내에서 사용할 임시 변수 - 메서드 실행 시에만 유효
    }
}
