...
LSP: 리스코프 지원 원칙 - 자식 클래스는 부모 클래스를 대체 할 수 있어야한다
...
class CreditCardPaymentProcessor implements  PaymentProcessor {
    ...
    public void processPayment(Order order) {
        ...
        System.out.println("결제 금액은 : " + order.getAmount() + "입니다.");
    }
}
...
public class C_OOP_Practice {
    public static void main(String[] args) {
        ...
        PaymentProcessor samsungPaymentProcessor = new SamsungPayPaymentProcessor();
        ...
        OrderService orderService2 = new OrderService(samsungPaymentProcessor, generateReport);
