...
// === 제네릭 와일드 카드 === //
// : 제네릭 타입을 사용할 때 정확환 타입을 모를 경우 사용하는 특수 기호
...
public class B_Generic {
    public static void main(String[] args) {
        ...
        // == 2) 일반 와일드 카드 (사용 권장x)== //
        // ? : 어떤 타입이든 허용
        // >> 와일드 카드의 구조체에 값을 할당하는 경우
        // >> 값을  꺼내올 수는 있음!

        List<?> list1 = new ArrayList<>();
        // list1.add("안녕"); - 타입의 불분명성으로 타입추가가 불가
        list1.add(null); // Object 값에는 반드시 null값이 허용된다
        ...
        // >> Integer(정수), 정수가 담길 수 있는 상위 타입 허용(Integer, Number, Object 등)
        integerList.add(123);
        integerList.add(7777);
        // integerList.add(123.456); // Integer에 안담겨져있으므로 불가능
    ...
    // cf) 일기 전용 사용 (List<Integer>, List<Double>, 등의 인자를 모두 제공 받는 메서드)
