            ...
            try {
                ...
                switch (choice) {
                    case 1:
                        ...
                        // Int의 값을 넣을려면 Integer.parseInt를 이용해서 변수를 받고 넣어줘야한다
                    ...
                    case 6:
                        ...
                        List<Item> categoryResult = manager.search(searchCategory);

                        if (categoryResult.isEmpty()) {
                            System.out.println("No items found in category: " + categoryResult);
                        } else {
