...
// - abstract 키워드 사용 + 구현부 {} 대신 세미콜로(;)을 사용하여 선언을 마침
...
//class Liger extends Lion extends Tiger {} - 다중 상속이 불가능하다
...
public class A_Abstract {
    public static void main(String[] args) {
        // Human human = new Human(); // 'Human' 은 abstract 이며, 인스턴스화 할 수 없다.
