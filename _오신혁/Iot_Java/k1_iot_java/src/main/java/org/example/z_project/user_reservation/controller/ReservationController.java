...
import org.example.z_project.user_reservation.service.ReservationServiceImpl;
import org.example.z_project.user_reservation.service.UserService;
import org.example.z_project.user_reservation.service.UserServiceImpl;
    ...
    public void run() {
        ...
        while (true) {
            ...
            if (!processChoice(choice, sc)) {
                break; // processChoice에 반환이 false일 경우 무한루프 종료 (7 >> false)
            }
        }
    }
    public void displayMenu() {
        System.out.println("1 사용자 등록 | 2. 로그인 | 3. 로그아웃");
        System.out.println("4 예약 등록 | 5. 예약확인 | 6. 예약취소");
        ...
        private boolean processChoice(int choice, Scanner sc) {
            ...
            switch (choice) {
                ...
                case 6:
                    ...
                    try {
                        // userId는 long 타입으로 명시되어있기때문에 형변환을 해줘야한다
                ...
                case 7:
                    ...
                    return false;
                default:
                    System.out.println("잘못된 선택입니다 유효한 기능을 선택해주세요. (1 ~ 7)");
