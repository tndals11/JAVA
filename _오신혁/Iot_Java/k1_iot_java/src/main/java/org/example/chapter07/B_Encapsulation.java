...
// == getter & setter 메서드 == //
// : 캡슐화 된 데이터에 안정하게 접근하고 수정할 수 있도록 하는 기능
// +) 데이터의 무결성 유지와 정보 은닉

// cf) 데이터보호 / 유지보수성 향상을 목적으로 데이터 필드(속성)을 private 선언
...
class Student {
    ...
    // cf) getter는 단순한 데이터의 반환 뿐만 아니라, 데이터 가공 역할을 담당하기도 한다
    ...
    // setter : 데이터를 받아 내부의 필드에 저장 (필드타입의 매개변수 & 반환타입x)
...
public class B_Encapsulation {
    public static void main(String[] args) {
        ...
        // student.name = "김승민"; -> private 설정 (해당 클래스 외에서는 접근 불가)
        student.setName("김승민");
        student.setAge(-30);
        student.setAge(29);
        student.setResidentNumber(2423445);
        student.setScore(50);
        student.setScore(100);

        student.setResidentNumber(34544646);
