...
// cf) 변수는 같은 범위 내에서 동일한 이름의 재선언이 불가능
...
class Calc {
    // 오버로딩의 성립조건 메서드명 동일, 매개변수의 타입[] 개수 차이, 반환타입은 무관


    // cf) 변수는 동일한 이름의 재정의 불가!
    int a;

    // long a; 같은 스코프 내에 동일한 이름 사용불가
    {
        int a;
...
public class F_Overloading {
    public static void main(String[] args) {
        ...
        System.out.println(calc.add(10.2, 20.5));
