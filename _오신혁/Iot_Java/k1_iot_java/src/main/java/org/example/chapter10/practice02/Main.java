...
public class Main {
    ...
    private static void viewAllItems(InventoryService service, Scanner sc) {
        ...
        List<Item> allItems = new ArrayList<>(service.getItemByCategory("Electronics"));
        allItems.addAll(service.getItemByCategory("Furniture"));
